...
OUTPUT_ARCH(i386)
ENTRY(_start)
SEARCH_DIR("/usr/local/google/builder/.pulse-agent/data/recipes/349047349/base/real_clients/nacl/googleclient/native_client/tools/sdk/nacl-sdk/nacl/lib");
PHDRS
{
...
SECTIONS
{
  ...
  PROVIDE (__executable_start = 0x00020000); . = 0x00020000;
  .interp         : { *(.interp) }
