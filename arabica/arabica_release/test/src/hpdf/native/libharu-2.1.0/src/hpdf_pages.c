...
int
HPDF_Page_GetWidth_1  (HPDF_Page    page)
{
    return (int) HPDF_Page_GetMediaBox (page).right;
}
...
int
HPDF_Page_GetHeight_1  (HPDF_Page    page)
{
    return (int) HPDF_Page_GetMediaBox (page).top;
}
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetWidth_1  (HPDF_Page    page,
                     int   value)
{
    HPDF_PTRACE((" HPDF_Page_SetWidth\n"));
    if (value < 3 || value > 14400)
    ...
    if (HPDF_Page_SetBoxValue (page, "MediaBox", 2, (HPDF_REAL) value) != HPDF_OK)
        return HPDF_CheckError (page->error);
...
HPDF_Page_SetHeight  (HPDF_Page    page,
                      HPDF_REAL    value)
{
    HPDF_PTRACE((" HPDF_Page_SetHeight\n"));
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetHeight_1  (HPDF_Page    page,
                      int    value)
{
    HPDF_PTRACE((" HPDF_Page_SetHeight\n"));
    ...
    if (HPDF_Page_SetBoxValue (page, "MediaBox", 3, (HPDF_REAL) value) != HPDF_OK)
    {
        return HPDF_CheckError (page->error);
    }
