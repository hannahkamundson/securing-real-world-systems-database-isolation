...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetCharSpace_1  (HPDF_Page  page,
                         int  value)
{
    HPDF_STATUS ret = HPDF_Page_CheckState (page, HPDF_GMODE_PAGE_DESCRIPTION |
                    HPDF_GMODE_TEXT_OBJECT);
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetWordSpace_1  (HPDF_Page  page,
                         int  value)
{
    HPDF_STATUS ret = HPDF_Page_CheckState (page, HPDF_GMODE_PAGE_DESCRIPTION |
                    HPDF_GMODE_TEXT_OBJECT);
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetFontAndSize_1  (HPDF_Page  page,
                           HPDF_Font  font,
                           int  size)
{
    HPDF_STATUS ret = HPDF_Page_CheckState (page, HPDF_GMODE_PAGE_DESCRIPTION |
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_MoveTextPos_1  (HPDF_Page  page,
                        int  x,
                        int  y)
{
    HPDF_STATUS ret = HPDF_Page_CheckState (page, HPDF_GMODE_TEXT_OBJECT);
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetTextMatrix_1  (HPDF_Page         page,
                          double    a,
                          double    b,
                          double    c,
                          double    d,
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_SetRGBFill_1  (HPDF_Page  page,
                       double  r,
                       double  g,
                       double  b)
{
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_DrawImage_1  (HPDF_Page    page,
                      HPDF_Image   image,
                      int    x,
                      int    y,
                      int    width,
...
HPDF_EXPORT(HPDF_STATUS)
HPDF_Page_TextOut_1  (HPDF_Page    page,
                    int    xpos,
                    int    ypos,
                    const char  *text)
{
